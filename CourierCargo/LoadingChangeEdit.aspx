<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LoadingChangeEdit.aspx.cs" Inherits="LoadingChangeEdit" %>
...
<body topmargin  = 0  rightmargin = 0  leftmargin = 0 >
            ...
            <tr>
                ...
                <td height = 204 valign=top style="width: 566px"  >
               <table>
                  <tr>
                                    ...
                                    <table style="width: 100%">
                                        ...
                                        <tr>
                                            <td style="width: 100px">
                                                <span style="font-size: 10pt; color: #4d6064; font-family: Verdana">Select Lot</span></td>
                                            <td style="width: 100px">
                                                <table style="width: 100%">
                                                    <tr>
                                                        <td style="width: 100px">
                                                            <asp:DropDownList ID="cbolot"
        runat="server" DataSourceID="SqlDataSource4" DataTextField="Lot_No" DataValueField="ID"
        Width="162px" OnSelectedIndexChanged="cbolot_SelectedIndexChanged">
    </asp:DropDownList></td>
                                                        <td style="width: 100px">
        <asp:Button ID="Button2" runat="server" OnClick="Button2_Click"
        Text="Search >>" Width="150px" /></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
        ...
        <asp:RadioButton ID="RadioButton1" runat="server" AutoPostBack="True" OnCheckedChanged="RadioButton1_CheckedChanged"
            Text="Truck" Width="70px" /></span></td>
                                            <td style="width: 100px">
                                                <span style="font-size: 10pt; color: #4d6064; font-family: Verdana">&nbsp;<asp:RadioButton ID="RadioButton2" runat="server" AutoPostBack="True" OnCheckedChanged="RadioButton2_CheckedChanged"

<%@ Page Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="FrmBooking.aspx.cs" Inherits="FrmBooking1" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
        <td align="left" style="width: 100px; height: 21px">
            <span style="font-size: 9pt; color: #4d6064; font-family: Verdana">By User Id</span></td>
        <td align="left" style="width: 100px; height: 21px">
        ...
        <td align="left" style="width: 100px; height: 22px;">
            <table style="width: 100%">
                <tr>
                    ...
                    <td style="width: 100px">
                        <asp:DropDownList ID="cboExpMonth" runat="server" Width="48px" OnSelectedIndexChanged="cboExpMonth_SelectedIndexChanged">
    ...
    <tr>
        <td align="left" style="width: 100px; height: 38px;">
            <asp:Button ID="btnBook" runat="server" Text="Book" Width="98px" OnClick="btnUpdate_Click" />
        </td>
        <td align="left" style="width: 100px; height: 38px;">
                                            &nbsp;<asp:Button ID="BtnSearch" runat="server" 
                                                PostBackUrl="~/FrmBookingEdit.aspx" Text="Search >>"
                                                Width="95px" CausesValidation="False" onclick="BtnSearch_Click" />
        </td>
    </tr>
</table>

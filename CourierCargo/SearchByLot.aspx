<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SearchByLot.aspx.cs" Inherits="SearchByLot" %>
                        ...
                        <tr bordercolor="#ffffff">
                            ...
                            <td style="width: 448px; height: 249px;" align="left" valign="top">
                                            ...
                                            <table style="width: 100%">
                                                <tr>
                                                    <td style="width: 109px">
                                                        <asp:DropDownList ID="cboLotNo" runat="server" Width="143px" DataSourceID="SqlDataSource1" DataTextField="LotNo" DataValueField="ID">
                                                        </asp:DropDownList></td>
                                                    <td style="width: 83px">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CourierServiceConnectionString %>"
                                    SelectCommand="SELECT [ID], [LotNo] FROM [Lot] WHERE (([LotStatus] <> @LotStatus) AND ([LotStatus] <> @LotStatus2))">
                                    <SelectParameters>
                                        <asp:Parameter DefaultValue="0" Name="LotStatus" Type="Int32" />
                                        <asp:Parameter DefaultValue="3" Name="LotStatus2" Type="Int32" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
                            </td>
                       </tr>

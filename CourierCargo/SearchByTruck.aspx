<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SearchByTruck.aspx.cs" Inherits="SearchByTruck" %>
                                    ...
                                    <tr>
                                        <td colspan="2" style="height: 15px">
                                            <strong><span style="font-size: 8pt; color: #0033cc; font-family: Verdana">Enquire Booking
                                                Status by Truck No</span></strong></td>
                                    </tr>
                                    <tr>
                                            ...
                                            <table style="width: 100%">
                                                <tr>
                                                    <td style="width: 139px">
                                                        <asp:DropDownList ID="cboTruckNo" runat="server" Width="202px" DataSourceID="SqlDataSource1" DataTextField="TruckNo" DataValueField="ID">
                                                        </asp:DropDownList></td>
                                                    <td style="width: 83px">

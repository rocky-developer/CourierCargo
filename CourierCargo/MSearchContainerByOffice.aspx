<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MSearchContainerByOffice.aspx.cs" Inherits="MSearchContainerByOffice" %>
                                        ...
                                        <td style="width: 100px">
                                            <table style="width: 100%">
                                                <tr>
                                                    ...
                                                    <td style="width: 100px">
                                                        <asp:Button ID="btnSearch" runat="server" Text="Search >>" Width="98px" OnClick="btnSearch_Click" PostBackUrl="~/MSearchContainerByOffice.aspx" /></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 172px" valign="top">
                                            <span style="font-size: 8pt; color: #4d6064; font-family: Verdana">
                                                <asp:Label ID="lblLabel" runat="server" Text="Container Currently Staying"
                                                    Width="173px"></asp:Label></span></td>
                                        <td style="width: 100px">
                                            <asp:ListBox ID="lstTruck" runat="server" Width="238px" DataSourceID="SqlDataSource2" DataTextField="ContainerNo"></asp:ListBox></td>
                                    </tr>
                                </table>
                                <span style="font-size: 8pt; color: #4d6064; font-family: Verdana">
